...
def one_liner(words: List[str], pref: str) -> int:
    return sum(map(lambda word: len(word) >= len(pref) and pref == word[:len(pref)], words))

if __name__ == "__main__":
    testcases: List[Tuple[Any, Any]] = [
        ((["pay","attention","practice","attend"], "at"), 2),
        ((["leetcode","win","loops","success"], "code"), 0),
        ((["jqclbnvrbpdivpsrnlziatmqxxezmcalpnzuczafqpdpdcyuckdddylevyemabynhxrvnjakjlsglcfnylldll","wzpsyqbydaaqyhjmbwfdvkgeyu","kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmurkreyfyvraojedbdoxec","kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmutmjfwmcammqvodenwxatsouojdgdpkxsabgve","kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmuzsndtnkhdzrcgtkzeafa","cciaewsuyzccnzziczcmuaohsnudsuptlgrdzzryajluaxghxbwf","amtodzsovkmgdlw","kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmuiqvnsluuynyblohrhhlqhakkcdabwklwsk","cqgytlphkffnmmmahesxelsicqyjyfullvymoqceemtnpyfgejcnabjeinljtfespnwvftldcholuujys","kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmunyockixnilatozvfkyqpbzcfnkpexbghjsklu","wqhngwactepbsbmqahnjannhssnyazgbnrfygfqdpddqpotffkcgvepfmfmjvinpayfgkeimywrdfiisndvavkuuzdydvd","gtahklmdpknhtzdxfxherktwctnwvrjudmmtyqtqxohzeziimvbus","kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmunbzcuaekqqhwozxdnldfb","egfkuytqptzqewpweeokurqmnqiyqdyeihucxzmgdu","kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmutcgvtqoxgmwjmqdckyksnpgqbncsljzbpkpdy","kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmuhzxpkltm","kbvytpxvmuojitddvttknckrtbxhkobijobcv"], "kwrxrkemzzrftxzyxrnsiybqnlvmljljcpokfngosdyekhqaftmhjmixsytepmu"), 8)
    ]
